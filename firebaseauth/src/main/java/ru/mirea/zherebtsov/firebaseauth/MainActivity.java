package ru.mirea.zherebtsov.firebaseauth;
...
import ru.mirea.zherebtsov.firebaseauth.databinding.ActivityMainBinding;
            ...
            binding.signInButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!email.isEmpty() && !password.isEmpty())
                    {
                        ...
                        Toast.makeText(MainActivity.this, "Необходимо заполнить все поля",
