package ru.mirea.zherebtsov.httpurlconnection;
...
import ru.mirea.zherebtsov.httpurlconnection.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public class DownloadPageTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            binding.textView1.setText("Загрузка...");
        }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                String x = coordinats[0];
                String y = coordinats[1];
                new DownloadWeatherTask().execute("https://api.open-meteo.com/v1/forecast?latitude=" + x + "&longitude=" + y + "&current_weather=true");
                binding.textView1.setText(locate);
    ...
    public class DownloadWeatherTask extends DownloadPageTask {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            binding.textView2.setText("Загрузка...");
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                binding.textView2.setText(weather);
            } catch (JSONException e) {
                e.printStackTrace();
            }
            super.onPostExecute(result);
